...
namespace Edubase.UnitTest.Controllers
{
    ...
    public class EstablishmentsSearchControllerTest
    {
        ...
        //     {
        //         new LookupDto {Id = 2, Name = "TESTLA"}, new LookupDto {Id = 3, Name = "BOB"}
        //     });
        //     cls.Setup(x => x.EstablishmentStatusesGetAllAsync()).ReturnsAsync(new[]
        //     {
        //         new LookupDto {Id = 1, Name = "status1"}, new LookupDto {Id = 2, Name = "status2"}
        //     });
        //     cls.Setup(x => x.GetNameAsync(It.IsAny<string>(), It.IsAny<int?>(), It.IsAny<string>()))
        //         .ReturnsAsync("bob");
        //     ers.Setup(x => x.CanAccess(It.IsAny<int>(), It.IsAny<IPrincipal>()))
        //         .ReturnsAsync(() => new ServiceResultDto<bool>(false));
        //     ers.Setup(x => x.GetPermittedStatusIdsAsync(It.IsAny<IPrincipal>())).ReturnsAsync(new[] {1});
        //     ers.Setup(x => x.SearchAsync(It.IsAny<EstablishmentSearchPayload>(), It.IsAny<IPrincipal>())).ReturnsAsync(
        //         () => new ApiPagedResult<EstablishmentSearchResultModel>(2,
        //             new List<EstablishmentSearchResultModel>
        //             {
        //                 new EstablishmentSearchResultModel {Name = "School 1"},
        //                 new EstablishmentSearchResultModel {Name = "School 2"}
        //             }));
        //
        //     var subject = new EstablishmentsSearchController(ers.Object, eds.Object, cls.Object, upr.Object);
        //     subject.ControllerContext = new ControllerContext(context.Object, new RouteData(), subject);
