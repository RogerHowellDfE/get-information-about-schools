...
namespace Edubase.Services.Texuna.Core
{
    public class ClientWrapperBase
    {
        ...
        public ClientWrapperBase(HttpClient httpClient, JsonMediaTypeFormatter formatter, IClientStorage clientStorage, ApiRecorderSessionItemRepository apiRecorderSessionItemRepository)
        {
